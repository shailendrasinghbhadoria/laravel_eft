<head>
        ...
        <div class="container">	
            ...
            <div class="bottom_right">			
                <div class="topnav" id="myTopnav">
                    ...
                    <?php if(Session::get('user') && Session::get('id')): ?>
                    <div style="float: right;"><a style="padding-right:10px" href="/profile/<?php echo e(Session::get('id')); ?>">Welcome | <?php echo e(Session::get('user')); ?></a>
                    <a style="padding-right:0;"href="/logout" class="menu5"><span>Logout</span></a></div>
                    <?php else: ?>
    ...
    <?php /**PATH E:\xampp\htdocs\laravel_project\eft\resources\views/header.blade.php ENDPATH**/ ?>